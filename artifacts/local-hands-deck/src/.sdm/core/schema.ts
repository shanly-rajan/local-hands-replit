...
export const BulletSchema = Type.Union(
  ...
  {
    description:
      'Paragraph bullet formatting. kind "none" is an explicit override that suppresses inherited list bullets.',
  },
);

export const ListLevelStyleSchema = Type.Object(
  {
  ...
  },
  {
    ...strict,
    description:
      'Shared list formatting for one indentation level. Paragraph fields are sparse direct-formatting overrides.',
  },
);

export const ListStyleSchema = Type.Record(
  Type.String({ pattern: '^[0-8]$' }),
  ListLevelStyleSchema,
  {
    additionalProperties: false,
    maxProperties: 9,
    description:
      'Reusable paragraph and bullet defaults keyed by list level. Prefer this over repeating identical formatting on every paragraph.',
  },
);
...
export const TextBodySchema = Type.Object(
  {
    ...
    listStyle: Type.Optional(ListStyleSchema),
...
export type ListLevelStyle = Static<typeof ListLevelStyleSchema>;
export type ListStyle = Static<typeof ListStyleSchema>;
